                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control custom-select" name="sort" id="sort">
                                ...
                                <option value="id_asc" <?php if(request()->query('sort') === 'id_asc'): ?> selected <?php endif; ?>><?php echo app('translator')->get('admin.id_asc'); ?></option>
                                <option value="id_desc" <?php if(request()->query('sort') === 'id_desc'): ?> selected <?php endif; ?>><?php echo app('translator')->get('admin.id_desc'); ?></option>
                            </select>
                        </div>
                    </div>
                </div>
