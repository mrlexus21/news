    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-12">
                <h4 class="block-heading"><?php echo app('translator')->get('main.all_news'); ?></h4>
...
<?php /**PATH /media/mrlexus/3CA2BF8DA2BF49E2/Projects/laravel/news/resources/views/components/news-list-paginate.blade.php ENDPATH**/ ?>